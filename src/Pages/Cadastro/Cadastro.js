    ...
    function Cadastro(){
        ...
        <div className="base-cadastro"> 
            <div className="retangulo-cadastro">
                ...
                <input className="caixa-cadastro" placeholder="Endereço de E-mail"></input>
                <input className="caixa-cadastro" placeholder="Nome de perfil"></input>
                <input className="caixa-cadastro" placeholder="Senha"></input>
                <input className="caixa-cadastro" placeholder="Confirmar senha"></input>
                <input className="caixa-cadastro" placeholder="Numero de telefone"></input>
                ...
                <div className="entrar-cadastro">
                    já é cadastrado?
                    <button className="btn-cadastro" onClick = {()=>{history.push("login");}}>entrar</button>
                    </div>
                </div>
